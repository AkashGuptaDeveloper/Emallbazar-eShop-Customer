...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
  ...
  bool available = true, outOfStock = true;
  int? selectIndex = 0;
  List<String> proIds1 = [];
      ...
      try {
        ...
        ApiBaseHelper().postAPICall(getProductApi, parameter).then(
          ...
          if (!error) {
            ...
            List<String> selList = widget.model!
                .prVarientList![widget.model!.selVarient!].attribute_value_ids!
                .split(',');
            ...
            for (int i = 0; i < widget.model!.attributeList!.length; i++) {
              ...
              List<String> sinList =
                  widget.model!.attributeList![i].id!.split(',');
